 ...
 * separately.
 * @param {Script} scriptSig - the script's first vcl (corresponding to the tx input)
 * @param {Script} scriptPubkey - the script's last vcl (corresponding to the tx output)
